...
def read_Input():
    wb = xlrd.open_workbook(os.path.join('C:\Users\SaiPhani\Desktop\Python\Plotting','Si_plot.xlsx'))
    wb.sheet_names()
...
def main():
    read_Input()
    window_Span = input("Please enter the window span")
